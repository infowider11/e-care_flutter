// ignore_for_file: non_constant_identifier_names, prefer_interpolation_to_compose_strings, deprecated_member_use, avoid_print
        ...
        sampleEvents.add(
          CalendarEvent(
            ...
            eventDate: DateTime.parse(
                res['data'][i]['date'] + ' ' + res['data'][i]['start_time']),
                                ...
                                child: Container(
                                  ...
                                  child: MainHeadingText(
                                    text: '${available_slot[i]['date']}, '
                                        ...
                                        '(${available_slot[i]['duration']} minute consultation available)',
                                    color: selected_inx == i
                                        ? Colors.white
                                        : MyColors.primaryColor,
                                    fontSize: 14,
                    ...
                    onTap: selected_inx != null
                        ? () async {
                            ...
                            Map<String, dynamic> data = {
                              ...
                              'slot_id': available_slot[selected_inx!]['id']
                                  .toString(),
                            ...
                            push(
                                ...
                                screen: ScheduleAppoint(
                                    api_request: data,
                                    booking_id: '',
                                    booking_data: available_slot[
                                        selected_inx!] //res['data']['slot_data'],
                                    ));
                            // Successpopup(context);
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: const Column(
        ...
        children: [
          ...
          Text(
              'Your selected consultation slot has been provisionally booked and we have sent a booking request to your healthcare provider'
