      ...
      body: Padding(
        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              MainHeadingText(text: 'Congratulations', fontFamily: 'light', fontSize: 32,),
              vSizedBox4,
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    vSizedBox2,
                    MainHeadingText(textAlign: TextAlign.center, text: 'Appointment Scheduled', fontSize: 24, fontFamily: 'light',),
                    ...
                    vSizedBox2,
                    MainHeadingText(textAlign: TextAlign.center, text: ' If your consultation does not take place, please send us a message via the app '
