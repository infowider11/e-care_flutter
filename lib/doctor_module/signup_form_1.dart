      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                RoundEdgedButton(text: 'Upload', width: 120,onTap: ()async{
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                          ...
                          child: CustomTextField(controller: expiry_date, hintText: '10/16',enabled: false,)),
                    ],
                  )
                )
              ],
            ...
            Row(
              children: [
                RoundEdgedButton(text: 'Upload proof', width: 155,onTap: ()async{
            ...
            RoundEdgedButton(text: 'Save', onTap: (){
              ...
              // }
                ...
                showSnackbar('Please Enter HPCSA registration number.');
                ...
                widget.data['specialist_subcat']=subCategories.length==0?'':subCatType;
                ...
                // hpcsa_image
                Navigator.push(context, MaterialPageRoute(builder: (context) => SignUpForm2(data: widget.data, files:files,)));
              }
