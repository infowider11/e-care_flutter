          ...
          children: [
              ...
              children: [
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: ParagraphText(text: 'Male', fontFamily: 'light', fontSize: 11, color: (gender=='male')?MyColors.white:MyColors.headingcolor,)
                  ),
                ),
                hSizedBox,
                GestureDetector(
                  ...
                  child: Container(
                      ...
                      child: ParagraphText(text: 'Female', fontFamily: 'light', fontSize: 11, color: (gender=='female')?MyColors.white:MyColors.headingcolor,)
                  ),
                ),
              ],
            ),
            ...
            RoundEdgedButton(
              ...
              onTap: (){
                  ...
                  validateString(dob.text,"Please enter your date of birth.",context)==null &&
                  validateString(password.text,"Please enter your last name.",context)==null
                  )
                  {
                    ...
                    print('[data]------${data}');
                    push(context: context, screen: SignUpForm1(data: data,));
                  }
